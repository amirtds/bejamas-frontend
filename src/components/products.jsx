  ...
  function filterProducts() {
    if (activeCategories.length === 0 && activePriceRange === undefined) {
      ...
      if (activePriceRange == "1") {
        setFilteredProducts(
          allProducts.filter((product) => product.price <= 20)
        );
        ...
        setFilteredProducts(
          allProducts.filter((product) => product.price > 100)
        );
      }
    } else if (
      activeCategories.length !== 0 &&
      ...
      if (activePriceRange == "1") {
        setFilteredProducts(
          allProducts.filter(
            (product) =>
              activeCategories.includes(product.category) && product.price <= 20
          )
        );
      } else if (activePriceRange == "2") {
        setFilteredProducts(
        ...
        setFilteredProducts(
          allProducts.filter(
            (product) =>
              activeCategories.includes(product.category) && product.price > 100
          )
        );
      }
    }
